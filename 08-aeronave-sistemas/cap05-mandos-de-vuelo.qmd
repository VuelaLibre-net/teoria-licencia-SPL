...
![Aerofrenos extendidos](imagenes/08-cap05-8-5-3-1-el-aerofreno.png){#fig-08-cap05-8-5-3-1-el-aerofreno}
...
![Flaps](imagenes/08-cap05-8-5-3-2-flaps.png){#fig-08-cap05-8-5-3-2-flaps}
...
![El compensador](imagenes/08-cap05-8-5-3-2-el-compensador-trim-tab-en-ingle.png){#fig-08-cap05-8-5-3-2-el-compensador-trim-tab-en-ingle width="50%"}

::: {.callout-note title="Airmanship"}
Los mandos de cabina siguen un código de colores que **no es una costumbre, sino un requisito de certificación**: lo fija CS 22.780, y CS 22.1555 obliga a marcarlos conforme a él. **Azul** para los aerofrenos, **verde** para el compensador, **amarillo** para la suelta del cable de remolque y **rojo** para la suelta de cúpula —el blanco queda para su apertura normal, y si una sola palanca hace las dos cosas, manda el rojo—. La norma **reserva** además esos dos colores: ningún otro mando de la cabina puede ser amarillo ni rojo, y por eso el ojo puede fiarse de ellos. Localízalos en cada planeador antes de volar.
:::
...
* **Código de colores (CS 22.780)**: azul (aerofrenos), verde (compensador), amarillo (suelta de remolque), rojo (suelta de cúpula). No es una costumbre: lo exige la certificación, que además reserva el amarillo y el rojo para esos mandos y se los prohíbe a todos los demás. Reconócelo al instante.
