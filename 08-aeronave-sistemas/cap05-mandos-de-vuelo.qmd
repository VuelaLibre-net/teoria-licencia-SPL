...
* **El compensador (**: de muelles o de pestaña, y por qué es tu mejor aliado.
...
El mando azul de la cabina acciona los aerofrenos
Aerofrenos (Spoilers)
. Su función es destruir parte de la sustentación y aumentar la resistencia, lo que te permite variar la pendiente de planeo sin tener que cambiar mucho la velocidad.
...
En los veleros de competición y en los biplazas de rendimiento, los flaps
Flaps
 modifican la curvatura del ala:
...
El mando verde, o el pulsador eléctrico que libera la carga de la palanca, es tu mejor aliado. El compensador
Compensador (Trim)
 no "vuela" el avión: alivia la presión que tendrías que hacer sobre el elevador para mantener una velocidad dada.
