...
* **Conexiones manuales (L’Hotellier)**: obligan al piloto a conectar a mano una rótula. Son conexiones críticas y han causado numerosos accidentes por olvido (ver @fig-08-cap07-conectores-mandos).

![Conector manual L’Hotellier con orificio visible para poner el pin de seguridad.](imagenes/08-cap07-conectores-mandos.jpg){#fig-08-cap07-conectores-mandos}
