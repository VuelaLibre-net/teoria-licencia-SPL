...
* **ELT (Emergency Locator Transmitter)**: va instalada de forma fija en el planeador. Se activa sola por el impacto (G) o a mano.
* **PLB (Personal Locator Beacon)**: baliza portátil que el piloto lleva en el bolsillo o en el paracaídas. Se activa a mano.

![Comunicador bidireccional vía satélite](imagenes/08-cap14-1-11-2-equipos-de-emergencia-a-bordo.png){#fig-08-cap14-1-11-2-equipos-de-emergencia-a-bordo width="45%"}
...
A medida que subes, la presión atmosférica baja y a tus pulmones les llegan menos moléculas de oxígeno. Eso provoca la **hipoxia**, con síntomas traicioneros: euforia, falta de concentración, visión de túnel. La fisiología completa de la hipoxia, el tiempo de conciencia útil y la regla «oxígeno al 100 % y desciende» se estudian en el **Libro 2 — Factores humanos, capítulo 4**. Aquí nos centramos en el equipo y en la norma.
...
2. **Sistemas EDS (Electronic Delivery System)**: dispositivos que detectan tu inspiración y sueltan un pulso de oxígeno justo cuando lo necesitas. Multiplican por tres o cuatro la duración de la botella.

![Sistema de Demanda de Pulso Electrónico (EDS)](imagenes/08-cap14-sistema-de-demanda-de-pulso-electronico.png){#fig-08-cap14-sistema-de-demanda-de-pulso-electronico width="45%"}
...
![Componentes esenciales del kit de supervivencia y baliza PLB](imagenes/08-cap14-equipo-supervivencia.jpg){#fig-08-cap14-equipo-supervivencia width="45%"}
