...
::: {.arco-blanco}
**Arco blanco**: sólo lo llevan los planeadores con flaps (capítulo 5). Marca el rango de uso de las posiciones **positivas**, desde 1,1 veces la velocidad de pérdida con los flaps en la posición de aterrizaje hasta la **V~FE~**, la velocidad máxima con flaps extendidos. Ocupa la parte baja de la esfera, solapado con el arco verde: bajar flaps por encima de la V~FE~ puede dañar el flap y su mando. Las posiciones **negativas** son otra cosa: sirven precisamente para correr entre térmicas, se usan muy por encima de ese arco y sus límites no están en la esfera, sino en la placa de limitaciones y en el Manual de Vuelo.
:::
...
El **triángulo amarillo** que llevan muchos veleros no es un arco, sino una marca suelta: la velocidad de aproximación recomendada con masa máxima sin lastre.

![Anemómetro moderno ADI2, con indicadores de velocidad, altitud y velocidad vertical](imagenes/08-cap06-8-6-4-2-anemometro.png){#fig-08-cap06-8-6-4-2-anemometro}

Estas marcas se complementan con las velocidades de remolque y torno indicadas en la placa de limitaciones y en el Manual de Vuelo. Y ojo en vuelo de onda a gran altitud: la V~NE~ **indicada** disminuye; el porqué se explica en el **Libro 5 — Principios de Vuelo**, capítulo 5.
...
![Un sistema de variómetro de energía total](imagenes/08-cap06-un-sistema-de-variometro-de-energia-tota.png){#fig-08-cap06-un-sistema-de-variometro-de-energia-tota}
...
![FLARM detectando otro planeador abajo "a las once"](imagenes/08-cap06-4-2-ver-y-evitar.png){#fig-08-cap06-4-2-ver-y-evitar}
...
* **Anemómetro**: conoce tus arcos de color. Blanco (sólo con flaps): posiciones positivas, hasta la V~FE~; las negativas se usan más deprisa y su límite está en la placa, no en la esfera. Verde: normal, hasta la V~RA~ (velocidad máxima en aire turbulento). Amarillo: precaución, de la V~RA~ a la V~NE~ (solo aire calmo). Línea roja: V~NE~, peligro de muerte. Triángulo amarillo: velocidad de aproximación con masa máxima sin lastre.
