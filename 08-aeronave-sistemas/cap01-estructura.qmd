...
![Esquema de la estructura de un ala de materiales compuestos (sándwich)](imagenes/08-cap01-estructura-ala.jpg){#fig-08-cap01-estructura-ala width="50%"}
...
![El interior de un cockpit moderno](imagenes/08-cap01-8-1-2-1-cabina-de-un-planeador.png){#fig-08-cap01-8-1-2-1-cabina-de-un-planeador}
...
![Un gancho de remolque de centro de gravedad (CG)](imagenes/08-cap01-planeador.png){#fig-08-cap01-planeador width="50%"}
