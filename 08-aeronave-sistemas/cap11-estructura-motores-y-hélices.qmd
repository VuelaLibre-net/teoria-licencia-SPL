...
* ****: un motor pequeño (casi siempre de dos tiempos) sin potencia para despegar. Su misión es sostener el vuelo y devolverte a casa si fallan las térmicas.
...
* ****: aeronaves con motor fijo (no escamoteable), como la Super Dimona, a medio camino entre el avión ligero y el planeador.
...
2. ****: la gran novedad. Usan una hélice plegable en el morro y baterías de litio. Son fiabilísimos, silenciosos y de arranque instantáneo.
