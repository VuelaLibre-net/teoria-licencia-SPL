...
: Dispositivo certificado por la _International Gliding Commission_ (Comisión Internacional de Vuelo a Vela) que graba la traza GPS, la altitud de presión barométrica y una firma digital en un archivo `.igc` infalsificable, probando el paso por los puntos de viraje para validar récords y medallas FAI.
