...
: Proceso mental sistemático (por ejemplo, mediante el modelo DECIDE) empleado por el piloto para elegir la opción más segura como respuesta a un conjunto de circunstancias.
...
**AFIL (Plan de vuelo presentado en vuelo / Airborne Flight Plan)**
...
: El operador AFIS da a los pilotos información sobre viento, pista en uso y tráfico conocido, pero no emite autorizaciones ni controla el tráfico. La separación sigue siendo responsabilidad del piloto al mando.
...
**AIREP (Informe meteorológico en vuelo / Aircraft Report)**
...
**Altitud geométrica (ellipsoidal height)**
: Altitud que calcula el GNSS, medida sobre el elipsoide de referencia del WGS-84. No coincide con la altitud barométrica del altímetro —en la Península, la diferencia entre el elipsoide y el nivel medio del mar ronda los 50 m— y no debe usarse para comprobar límites de espacio aéreo ni la AMA.
...
**AUT / TUE (Autorización de Uso Terapéutico / Therapeutic Use Exemption)**
: Permiso oficial que conceden las organizaciones nacionales antidopaje y las federaciones internacionales —no la propia WADA, que fija el estándar y revisa las concesiones— y que permite a un piloto de competición utilizar una medicación específica que normalmente requeriría su suspensión en un control antidopaje, salvaguardando su salud de base.
...
**Bataneo (buffet)**
: Vibración de la estructura provocada por el aire desprendido del ala que golpea el fuselaje y la cola al acercarse al ángulo de ataque crítico. Es el aviso previo a la pérdida más perceptible, junto al morro alto y los mandos blandos. Importa en meteorología porque el hielo estructural lo suprime: con el perfil contaminado, el planeador puede entrar en pérdida muy por encima de su velocidad habitual y sin ningún aviso.
...
: Término de los informes meteorológicos que sustituye determinados datos de visibilidad, tiempo presente y nubes cuando se cumplen simultáneamente las condiciones establecidas: visibilidad de 10 km o más, sin nubes por debajo de 5.000 ft ni cumulonimbus, y sin tiempo significativo. El rótulo es el de OACI; en el club se oye el retroacrónimo *Ceiling And Visibility OK*, que no es la denominación oficial.
...
**Componente cruzada (crosswind component)**
: Parte del viento perpendicular a la trayectoria, igual a $V \cdot \sin\alpha$. Es la que produce deriva y obliga a corregir el rumbo; la componente restante, paralela a la trayectoria, sólo cambia la velocidad suelo.
...
**Computador de vuelo (whizz-wheel)**
: Regla de cálculo circular de dos caras: la de cálculo resuelve proporciones de tiempo, velocidad y distancia y conversiones de unidades; la del viento resuelve gráficamente el triángulo de velocidades. Los ordenadores de planeo hacen lo mismo en continuo con el viento medido en vuelo.
...
**Cono de alcance**
: Superficie de terreno alcanzable en planeo desde la posición y altura actuales, $D = h \cdot (L/D)$. En aire en calma es un círculo; el viento lo deforma en la proporción $GS/TAS$, encogiéndolo contra el viento y estirándolo a favor.
...
**Cúpula (Canopy)**
: Cubierta transparente de plexiglás de la cabina. Incorpora pestillos de bloqueo y ventilación, y forma parte de la salida de emergencia. Según el diseño, el procedimiento puede exigir abrirla, desprenderla o accionar varios mandos en el orden indicado por el AFM.
...
**DALR (Gradiente Adiabático Seco / Dry Adiabatic Lapse Rate)**
: Ritmo al que se enfría una parcela de aire sin saturar al ascender adiabáticamente: 3 °C por cada 1.000 ft. Es la clave del efecto Foehn en sotavento y de la fórmula de base de nubes.
...
**DECIDE**
: Modelo estandarizado para la toma de decisiones aeronáuticas, en seis pasos: **D**etect (detectar el cambio), **E**stimate (estimar si exige reacción), **C**hoose (elegir el resultado buscado), **I**dentify (identificar las acciones posibles), **D**o (ejecutar la elegida) y **E**valuate (evaluar su efecto).
...
**DOP (Dilución de la precisión / Dilution of Precision)**
...
: Error de la brújula al virar hacia rumbos Norte o Sur por efecto del *dip* magnético: al Norte la brújula se queda atrás (hay que sacar el viraje antes, "NO me paso") y al Sur se adelanta (hay que dejarla pasar, "SÍ me paso"). Su magnitud es del orden de la latitud del lugar.

**Error deliberado (dog-leg)**
: Técnica para localizar un punto pequeño: se vuela a propósito hacia un lado del objetivo, apuntando a una referencia lineal que pase por él, de modo que al alcanzarla no haya duda de hacia dónde girar. Cambia una duda por un rodeo.
...
: Volumen de espacio aéreo (clases A a E) en el que se presta servicio de control. En **clase A** sólo se admite IFR: el VFR no puede entrar. En **clases B, C y D** el VFR necesita autorización ATC y comunicación bilateral; la clase B no se emplea en España. La **clase E** también es espacio controlado, pero al VFR no se le presta allí servicio de control y no necesita ni autorización ni radio.
...
**ETE (Tiempo estimado en ruta / Estimated Time En route)**
: Tiempo previsto para recorrer un tramo, $ETE = D / GS$. Se calcula en tierra al preparar el vuelo; el ETA que se deriva de él se recalcula en vuelo con la velocidad suelo real.
...
: Mecanismo de enganche y suelta rápida del cable de lanzamiento, a menudo fabricado por Tost. El AFM y las placas indican qué gancho corresponde a cada método. En la configuración habitual, el de morro se destina al remolque por avión y el próximo al CG al torno; todo gancho autorizado para torno debe disponer de suelta automática (**back-release**).

**Gelcoat**
: Capa exterior de resina de poliéster que da a muchas estructuras de fibra su acabado liso y ayuda a proteger el laminado del ambiente. La radiación UV y los cambios de temperatura favorecen con el tiempo el craqueado superficial.
...
**Hipoxia**
: Estado fisiológico de deficiencia de oxígeno en las células y tejidos del cuerpo humano, provocado al volar a gran altura por la reducción de la presión parcial de oxígeno en la atmósfera. Existen cuatro tipos: hipóxica (baja presión atmosférica, la más frecuente en planeador), hipémica (transporte mermado por monóxido de carbono o tabaquismo), estancada (circulación reducida, por ejemplo por fuerzas G elevadas en virajes cerrados) e histotóxica (alcohol, drogas o medicamentos).
...
: Velocidad de la aeronave respecto al aire circundante tal como la indica el anemómetro, sin correcciones por temperatura ni densidad. Es la referencia para todos los límites aerodinámicos y estructurales (V~NE~, V~A~, velocidades de pérdida y curva polar). En navegación es además el punto de partida del cálculo: corregida por densidad da la TAS y, combinada con el viento, la GS; nunca se razona con la IAS a secas.
...
: Dispositivo electrónico, certificado por la _International Gliding Commission_ (Comisión Internacional de Vuelo a Vela), que graba la traza GPS, la altitud de presión barométrica y una firma digital en un archivo `.igc` que hace detectable cualquier manipulación, probando el paso por los puntos de viraje para validar récords y medallas FAI.
...
**Larguero (Spar)**
: Principal elemento resistente longitudinal del ala. Soporta buena parte de las cargas de flexión, mientras el revestimiento y otros elementos comparten cargas según el diseño. Un daño real o sospechado obliga a dejar el planeador fuera de servicio hasta su evaluación.
...
: Altitud a la que una parcela de aire, al ser elevada adiabáticamente, alcanza su punto de saturación y comienza a condensar. En la práctica, es la altura de la base de los cúmulos. En el sondeo Skew-T se construye cruzando dos líneas: la adiabática seca trazada desde la temperatura en superficie y la línea de relación de mezcla saturante trazada desde el punto de rocío en superficie. No debe confundirse con el punto en que las curvas de temperatura y de punto de rocío se juntan, que señala una capa ya saturada (niebla, estratos o nube existente). Estimación rápida: (T − Td) × 400 = altura en pies.
...
: Indicador en METAR/TAF que señala ausencia de nubes por debajo de 5.000 ft (o de la altitud mínima de sector más alta, la que sea mayor) y ausencia de cumulonimbus y de cúmulos congestus. Sólo se usa cuando no procede CAVOK: a diferencia de éste, no implica visibilidad ≥ 10 km. No afirma que el cielo esté despejado, sino que ninguna nube es operativamente significativa; para el cielo realmente despejado están `SKC` (**Sky Clear**), que escribe un observador humano, y `NCD` (**No Cloud Detected**), que emite una estación automática cuyos sensores no han detectado nubes.
...
**Part-MED (Requisitos médicos aeronáuticos)**
: Anexo IV del Reglamento (UE) n.º 1178/2011, que fija las condiciones médicas exigibles a las tripulaciones de vuelo y el régimen de los certificados médicos. Para la SPL basta el certificado médico LAPL.
...
: Baliza portátil de activación manual que el piloto lleva consigo (bolsillo o arnés del paracaídas) y que transmite en 406 MHz a la red satelital de rescate.

**Poliuretano (PU)**
: Sistema de pintura usado como acabado exterior en algunos veleros modernos. No se mantiene ni se repara igual que el gelcoat de poliéster, por lo que limpiadores, ceras, pulimentos y métodos de reparación deben ajustarse al manual de mantenimiento.
...
**PTT (Pulsar para hablar / Push-to-Talk)**
...
**SALR (Gradiente Adiabático Saturado / Saturated Adiabatic Lapse Rate)**
: Ritmo al que se enfría una parcela de aire saturada (en formación de nube) al ascender adiabáticamente: aproximadamente 1,5 °C por cada 1.000 ft. Es menor que el DALR porque la condensación libera calor latente que "frena" el enfriamiento.

**SAO (Operaciones de Planeadores / Sailplane Air Operations)**
: Normativa operativa específica de EASA para planeadores, en el anexo II del Reglamento (UE) 2018/1976. Sus reglas son de criterio antes que de umbral: **SAO.OP.150** obliga al piloto al mando a garantizar que todos los ocupantes usen oxígeno suplementario cuando determine que, a la altitud prevista, su falta puede mermarles las facultades. El Reglamento no fija ninguna cifra; los **10.000 ft** salen del **AMC1 SAO.OP.150**, y sólo como regla por defecto para cuando el piloto no pueda hacer esa valoración.
...
**SFCL (Licencias de Tripulación de Vuelo de Planeadores / Sailplane Flight Crew Licensing)**
...
**SIGWX (Mapa de Tiempo Significativo / Significant Weather Chart)**
: Pronóstico a escala sinóptica que muestra la distribución de sistemas frontales, zonas de turbulencia e engelamiento, y otras áreas de meteorología significativa en una región geográfica. Imprescindible para la planificación de vuelos de distancia.
...
: Informe meteorológico especial de aeródromo, con el mismo formato que el METAR, emitido fuera del ciclo regular en cuanto una condición cambia de forma significativa: viraje o aumento del viento, cruce de un umbral operativo de visibilidad o de base de nubes, aparición de tormenta. Prevalece sobre el METAR vigente por ser posterior.
...
**Squawk**
: Código de cuatro dígitos en base octal (0–7) que el transpondedor emite al ser interrogado por el radar secundario (SSR), permitiendo al controlador identificar la aeronave en pantalla. Código VFR estándar en Europa: 7000. Los códigos 7700 (emergencia), 7600 (fallo de radio, NORDO) y 7500 (interferencia ilícita) son de uso exclusivo en esas situaciones.

**SRM (Gestión de recursos del piloto único / Single-Pilot Resource Management)**
: Habilidad para administrar todos los recursos disponibles (instrumentos, ATC, listas de chequeo) para operar de forma segura, reduciendo la carga de trabajo y minimizando el riesgo de errores sistemáticos.
...
**Transpondedor (transponder, XPDR)**
...
**TUC (Tiempo útil de conciencia / Time of Useful Consciousness)**
: Intervalo crítico en el que el piloto retiene sus capacidades cognitivas y motoras para tomar medidas correctivas tras una interrupción del suministro de oxígeno a gran altitud. Se reduce rápidamente a mayor altura.
...
**V~A~ (Velocidad de maniobra / Maneuvering Speed)**
: Velocidad máxima a la que pueden aplicarse deflexiones totales en un solo mando sin causar daños estructurales. Por debajo de V~A~, ante una deflexión brusca completa, el planeador entra en pérdida antes de generar suficientes Gs para superar su límite de carga. Por encima de V~A~, esa protección desaparece. Importante: la V~A~ no cubre entradas simultáneas en más de un eje de control; incluso por debajo de V~A~, combinar timón y palanca a fondo puede superar los límites estructurales.
...
**VDF (Radiogoniometría VHF / VHF Direction Finding)**
...
**V~NE~ (Velocidad de nunca exceder / Never Exceed Speed)**
: Límite absoluto de velocidad del planeador, indicado por la línea roja en el anemómetro. Superarla expone el planeador al riesgo de flutter aeroelástico, que puede desintegrar la estructura en segundos, sin previo aviso. La V~NE~ disminuye con la altitud porque la TAS crece respecto a la IAS en aire menos denso. Cerca de la V~NE~, las deflexiones de mando deben limitarse a un tercio de su recorrido total. La velocidad la regula CS 22.1505 y su línea roja, CS 22.1545(a); el límite de un tercio del recorrido es una advertencia que CS 22.1585(o)(2) obliga a incluir en el Manual de Vuelo.
...
**V~RA~ (Velocidad máxima en aire turbulento / Rough Air Speed)**
: Velocidad máxima a la que puede volarse en aire turbulento. Es la marca que separa los arcos del anemómetro según CS 22.1545: en la V~RA~ termina el arco verde (operación normal) y empieza el amarillo (precaución, solo aire en calma). No debe confundirse con la V~A~, que es un límite estructural frente a deflexiones de mando y no se marca en la esfera, aunque en muchos veleros ambas tengan valores próximos.
...
**WADA (Agencia Mundial Antidopaje / World Anti-Doping Agency)**
: Organización internacional que regula y controla exhaustivamente el consumo de sustancias y dopaje en deportistas de competición, siendo los campeonatos de vuelo a vela sometidos también a este mismo estándar.
