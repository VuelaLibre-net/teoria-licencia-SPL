...
| 5 | **`05-principios-vuelo`** | Principios de Vuelo | `1.0-rc.6` | 🟡 En revisión |
| 6 | **`06-procedimientos-operativos`** | Procedimientos Operativos | `0.9.2` | 🟡 En revisión |
| 7 | **`07-planificacion-rendimiento`** | Planificación y Rendimiento de Vuelo | `0.9.1` | 🟡 En revisión |
