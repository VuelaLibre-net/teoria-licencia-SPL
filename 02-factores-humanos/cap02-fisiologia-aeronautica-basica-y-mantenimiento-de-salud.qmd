...
::: {.callout-important title="Normativa"}
El **AMC1 SAO.GEN.130(f) y SAO.GEN.135(b)** (ED Decision 2019/001/R), titulado *Alcohol consumption*, concreta la regla «de la botella al mando» (**bottle to throttle**) para las tripulaciones de planeador: nada de alcohol en las **8 horas previas** al vuelo, una alcoholemia al inicio del vuelo que no supere **0,2 g/l** —o el límite nacional, si es más estricto— y **nada de alcohol durante el vuelo**. No lo confundas con el AMC1 SAO.GEN.130(f) a secas, que trata del buceo y la donación de sangre.
:::
...
* **Normativa EASA, medicación y alcohol:** La regla no tiene excepciones: **«de la botella al mando»**, 8 horas sin alcohol antes del vuelo, nada de alcohol durante el vuelo y alcoholemia inferior a 0,2 g/l —o al límite nacional, si es más estricto— (AMC1 SAO.GEN.130(f) y SAO.GEN.135(b)). No se automedique; hasta las inocentes pastillas de la alergia o del mareo adormecen de forma incapacitante para volar.
:::
