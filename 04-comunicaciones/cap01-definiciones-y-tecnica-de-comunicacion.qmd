...
![Pulsa el PTT (*Push-to-Talk*) de la palanca y espera un segundo antes de hablar; habla con un volumen normal y mantén el micrófono cerca de la boca sin tocarla. Cuando termines, suelta el PTT y asegúrate de que ya no estás emitiendo (se apagará el indicador *TX*).](imagenes/04-cap01-disciplina-radio.jpg){#fig-04-cap01-microfono}
