...
Un reporte de posición (**position report**) le dice al ATC
ATC (Control de Tránsito Aéreo / Air Traffic Control)
 o a otras aeronaves dónde estás. Lo emites al pasar por puntos de notificación obligatoria, cuando el FIS te lo pide o como actualización espontánea en travesía.
...
Es un problema más habitual de lo que parece, y más serio de lo que parece: el **micrófono bloqueado** o PTT
PTT (Push-to-Talk — Pulsar para Hablar)
 atascado. En los planeadores el botón PTT suele estar integrado en la palanca de mando, justo donde cualquier presión accidental puede activarlo.
...
El remedio es simple: **comprobación visual después de cada transmisión** (). La mayoría de radios de panel tienen un indicador **TX** en pantalla que se ilumina mientras transmites. Comprueba siempre que **se apaga** al soltar el botón.
...
* **Doble escucha (**: monitoriza dos frecuencias simultáneamente y transmite solo en la primaria. Útil para escuchar el FIS mientras trabajas con la torre.
...
* **Prueba de radio (**: Realízala solo si tienes dudas sobre la integridad del equipo. Usa la escala de legibilidad del 1 (ilegible) al 5 (perfecto): «Le recibo 5».
