...
::: {.callout-warning title="Seguridad"}
Una autorización para «entrar y alinear» o «entrar y mantener» en la pista activa **nunca** constituye una autorización para despegar. Debes permanecer inmóvil en la cabecera hasta escuchar explícitamente las palabras: *«Autorizado a despegar»* (**Cleared for take-off**). Si tienes cualquier duda, consulta: «Confirme, ¿autorizado salida?». No utilices jamás la palabra *despegar* salvo para colacionar (read-back) una autorización expresa.
:::
...
Si tu planeador tiene **transpondedor**, emite un código de cuatro dígitos (*squawk*) que el ATC usa para identificarte en pantalla. En VFR, el código por defecto es **7000**, salvo que el ATC te asigne uno distinto. Los códigos de emergencia los encontrarás en el capítulo 9.
