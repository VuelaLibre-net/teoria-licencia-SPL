...
Es una grabación de voz —normalmente sintética— que suena en bucle continuo en una frecuencia VHF propia, separada de la frecuencia de control (@fig-04-cap04-atis-escucha). Te dice:
...
![Secuencia de escucha del ATIS antes del contacto con Torre](imagenes/04-cap04-atis-escucha.jpg){#fig-04-cap04-atis-escucha}
...
Probablemente la palabra más bienvenida que puedes escuchar en el ATIS. *Ceiling and Visibility OK* (techo y visibilidad correctos) significa que se cumplen tres condiciones a la vez:
...
![Comparación del altímetro con ajuste QNH y QFE](imagenes/04-cap04-qnh-qfe.png){#fig-04-cap04-qnh-qfe}

### La dualidad del viento: magnético frente a geográfico

Cuando calculas el planeo final o la componente cruzada, necesitas saber en qué referencia está expresado el viento. No siempre es la misma (@fig-04-cap04-viento-magnetico-geografico).
...
![Diferencia entre viento magnético (radio) y geográfico (mapas)](imagenes/04-cap04-viento-mag-geo.jpg){#fig-04-cap04-viento-magnetico-geografico}
