...
El **transpondedor** (*XPDR*) responde automáticamente a los radares terrestres emitiendo un código de cuatro dígitos (*squawk*). Así el controlador ve tu aeronave identificada en pantalla.
...
* **Alcance Visual**: Las ondas VHF viajan en línea recta. Si hay una montaña entre la antena y tú, no te oirán. La altura es tu aliada: a mayor altitud, mayor alcance (1.23 × √H).
