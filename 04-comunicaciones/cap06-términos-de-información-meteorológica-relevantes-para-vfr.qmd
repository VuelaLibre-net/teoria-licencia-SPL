...
Sin el **** (**Automatic Terminal Information Service**), los controladores de Torre en aeródromos con tráfico medio o alto pasarían la mitad del día repitiendo lo mismo a cada aeronave que se aproxima. El ATIS existe para librarles de eso.

Es una grabación de voz —normalmente sintética— que suena en bucle continuo en una frecuencia VHF propia, separada de la frecuencia de control (). Te dice:
...
El ATIS te da el tiempo de un aeropuerto concreto. El **** (de **VOL METéorologique**) te da el tiempo de una región entera.

Es otra emisión pregrabada en bucle, pero en lugar de un aeródromo emite METAR
METAR (Meteorological Aerodrome Report)
, pronósticos TAF
TAF (Terminal Aerodrome Forecast)
 y avisos SIGMET de **un conjunto de aeropuertos de una misma región**.
...
Probablemente la palabra más bienvenida que puedes escuchar en el ATIS. 
CAVOK (Ceiling And Visibility OK)
 (techo y visibilidad correctos) significa que se cumplen tres condiciones a la vez:
...
* El **** es la presión atmosférica reducida al nivel medio del mar. Mételo en el altímetro y te dará **la altitud real** sobre el nivel del mar. Es el ajuste que usas en ruta y para respetar los límites verticales de los espacios aéreos (los techos de los CTR van en altitud QNH).
* El **** es la presión a la elevación del aeródromo. Con el QFE puesto, el altímetro marca **cero pies** en tierra: te indica altura sobre el campo, no altitud. En veleros casi no se usa ya, salvo en operaciones muy locales o acrobacia en aeródromo. El QNH es el ajuste de referencia en las comunicaciones ATS ().
...
Cuando calculas el planeo final o la componente cruzada, necesitas saber en qué referencia está expresado el viento. No siempre es la misma ().
...
El **** (**Aircraft Report**) es el informe que tú, como piloto, transmites al FIS o al ATC cuando encuentras en ruta condiciones meteorológicas peligrosas que no estaban pronosticadas.
