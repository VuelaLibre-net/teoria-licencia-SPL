...
Las comunicaciones aeronáuticas de voz se transmiten en la banda de **** (*Very High Frequency*), entre los 118.000 MHz y los 136.975 MHz, con modulación de amplitud (AM).
...
![Bloqueo orográfico de la señal VHF](imagenes/04-cap09-bloqueo-montana.jpg){#fig-04-cap09-bloqueo-montana}
...
Las ondas VHF viajan en línea recta y no atraviesan la roca. Si bajas por debajo de la cresta que te separa de la torre de control o del repetidor FIS de ENAIRE más cercano, sufrirás un **bloqueo orográfico** total (). Da igual cuánta potencia tenga tu radio: la señal se estrella contra la piedra.
...
El **** (*XPDR*) responde automáticamente a los radares terrestres emitiendo un código de cuatro dígitos (
Squawk
). Así el controlador ve tu aeronave identificada en pantalla.
...
* **Transpondedor (XPDR)**: Responde automáticamente al radar secundario (SSR)
  SSR (Secondary Surveillance Radar — Radar Secundario de Vigilancia)
  . Códigos: **7000** (VFR estándar), **7600** (fallo de radio — NORDO), **7700** (emergencia activa). Obligatorio en zonas TMZ
  TMZ (Zona de transpondedor obligatorio / Transponder Mandatory Zone)
   (SERA.6005 b) — descritas en AIP-España ENR 2.1, carta ENR 6— y donde lo exijan la clase de espacio aéreo o el AIP (ENR 1.6): clases A y C, y D generalmente. Botón **IDENT**: solo cuando lo pida el ATC.
