...
El remedio es simple: **comprobación visual después de cada transmisión** (@fig-04-cap03-luz-tx). La mayoría de radios de panel tienen un indicador **TX** en pantalla que se ilumina mientras transmites. Comprueba siempre que **se apaga** al soltar el botón.

![Comprobación del indicador de transmisión (TX)](imagenes/04-cap03-luz-tx.jpg){#fig-04-cap03-luz-tx}
