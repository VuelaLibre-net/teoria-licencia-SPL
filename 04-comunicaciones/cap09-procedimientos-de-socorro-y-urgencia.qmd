...
El PAN PAN
PAN PAN
 dice que tienes un problema serio que necesita **atención prioritaria** del ATC, pero no estás en peligro inmediato de accidente ni necesitas salvamento en los próximos segundos.
...
Con el corazón acelerado y las manos ocupadas, puede costar estructurar un mensaje. Pero los servicios de control y salvamento (SAR
SAR (Search and Rescue — Búsqueda y Salvamento)
) necesitan información concreta para localizarte y ayudarte. Esta es la secuencia ():
...
![Estructura de la llamada de emergencia](imagenes/04-cap08-estructura-emergencia.jpg){#fig-04-cap08-llamada-emergencia}
...
![Serie 1: el interceptor se coloca por delante y a tu izquierda, alabea y vira hacia el rumbo que debes seguir](imagenes/04-cap08-interceptacion-serie1.png){#fig-04-cap08-interceptacion-serie1}
