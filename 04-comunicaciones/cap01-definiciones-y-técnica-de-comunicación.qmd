...
3. **Pulsa y cuenta uno**: Pulsa el botón de PTT (*Push-To-Talk*) un segundo **antes** de hablar (). Así la primera sílaba no se corta mientras el transmisor abre la portadora.
