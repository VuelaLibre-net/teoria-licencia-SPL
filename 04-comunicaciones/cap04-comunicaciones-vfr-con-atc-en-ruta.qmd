...
En ruta por espacio aéreo no controlado —Clase G en su mayor parte— no hay ninguna Torre mirándote. Pero tienes una herramienta útil: el **** (*Flight Information Service*).
...
* **Meteorología**: METAR
  ...
  , alertas SIGMET o AIRMET en ruta o en tus aeródromos de destino y alternativo.
...
Cuando necesites cambiar de frecuencia, hay dos casos ():

* **Si estás bajo control **: Pide permiso. *"Torre, EC-DPE, solicito abandonar frecuencia para pasar a operaciones de club en 123.500"*.
...
Si tu planeador tiene ****, emite un código de cuatro dígitos (
Squawk
) que el ATC usa para identificarte en pantalla. En VFR, el código por defecto es **7000**, salvo que el ATC te asigne uno distinto. Los códigos de emergencia los encontrarás en el capítulo 9.
...
Algunos sectores de clase E, F o G llevan una obligación adicional: son **** (*Radio Mandatory Zone*). Dentro de una RMZ la radio no es optativa aunque el espacio aéreo no sea controlado; es una obligación publicada en el AIP.
