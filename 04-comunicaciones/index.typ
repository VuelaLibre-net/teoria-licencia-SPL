...
/ \*\*\*\*AFIL (Airborne Flight Plan --- Plan de Vuelo en Vuelo)\*\*\*\*: #block[
...
/ \*\*\*\*AFIS (Aerodrome Flight Information Service)\*\*\*\*: #block[
...
/ \*\*\*\*AIREP (Aircraft Report --- Informe Meteorológico en Vuelo)\*\*\*\*: #block[
...
/ \*\*\*\*ATIS (Automatic Terminal Information Service --- Servicio Automático de Información Terminal)\*\*\*\*: #block[
...
/ \*\*\*\*Autoinformación (broadcast)\*\*\*\*: #block[
...
/ \*\*\*\*FPL (Flight Plan --- Plan de Vuelo)\*\*\*\*: #block[
...
/ \*\*\*\*Interceptación (interception)\*\*\*\*: #block[
...
/ \*\*\*\*PTT (Push-to-Talk --- Pulsar para Hablar)\*\*\*\*: #block[
...
/ \*\*\*\*SAR (Search and Rescue --- Búsqueda y Salvamento)\*\*\*\*: #block[
...
/ \*\*\*\*SSR (Secondary Surveillance Radar --- Radar Secundario de Vigilancia)\*\*\*\*: #block[
...
/ \*\*\*\*Transpondedor (XPDR --- Transponder)\*\*\*\*: #block[
...
/ \*\*\*\*Transmisión a ciegas (blind transmission)\*\*\*\*: #block[
...
/ \*\*\*\*TWR (Torre de Control de Aeródromo)\*\*\*\*: #block[
...
/ \*\*\*\*VAC (Visual Approach Chart --- Carta de Aproximación Visual)\*\*\*\*: #block[
...
/ \*\*\*\*VDF (VHF Direction Finding --- Radiogoniometría VHF)\*\*\*\*: #block[
...
/ \*\*\*\*VHF (Very High Frequency --- Muy Alta Frecuencia)\*\*\*\*: #block[
...
/ \*\*\*\*VMC (Visual Meteorological Conditions --- Condiciones Meteorológicas Visuales)\*\*\*\*: #block[
