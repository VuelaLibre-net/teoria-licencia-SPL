...
La estabilidad direccional asegura que el planeador vuele alineado con el viento relativo, evitando el deslizamiento lateral (*sideslip*): esto es, que el aire llegue de costado en vez de de frente. Este efecto se consigue mediante el estabilizador vertical o deriva.
...
* **Estabilidad direccional**: la deriva (cola vertical) actúa como una veleta, manteniendo el morro apuntando al viento relativo y evitando el deslizamiento lateral (*sideslip*), tanto el resbale como el derrape.
:::
