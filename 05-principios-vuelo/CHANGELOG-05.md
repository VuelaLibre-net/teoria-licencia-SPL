...
* Los entregables llevan ahora la versión y la fecha en el nombre
  (`05-principios-vuelo-0.8.1-260716.pdf`), para identificarlos sin abrirlos.
* **Cada libro se publica también como un solo Markdown** (`make rag`, a
  `build/rag/05-principios-vuelo-0.8.1-260716.md`), para cargarlo como fuente en un asistente de
