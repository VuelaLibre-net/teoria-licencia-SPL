...
* **Cómo salir**: 1. nivela las alas (alerones y pie coordinados al lado contrario del viraje) —es lo primero, el alabeo sostiene la espiral—; 2. recupera suave del picado; 3. si la velocidad se acerca a la V~NE~, frena con aerofrenos (suavemente).
