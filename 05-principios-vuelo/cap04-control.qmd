...
El derrape es el que hay que evitar: el ala interior va más lenta y puede alcanzar el ángulo de ataque crítico sin previo aviso, iniciando una pérdida asimétrica. El resbale es más aparatoso —el fuselaje ofrece más resistencia y el viraje es ineficiente—, pero rara vez es peligroso por sí solo. La @fig-05-cap04-hilo-lana-estados resume los tres estados del hilo y su lectura.

![Los tres estados del hilo de lana en un giro a la izquierda, de izquierda a derecha: resbale, coordinado y derrape.](imagenes/05-cap04-hilo-lana-estados.png){#fig-05-cap04-hilo-lana-estados}
