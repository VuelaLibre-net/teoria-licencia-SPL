...
* **VNE (velocidad de nunca exceder)**: el límite absoluto de velocidad (CS 22.1505), marcado con la **línea roja** del anemómetro. No es una recomendación, es un límite físico. Pasarla invita al **flutter** (vibración aeroelástica), que puede desintegrar el planeador en segundos. Cerca de la VNE, limita las deflexiones de mando a un tercio de su recorrido.
