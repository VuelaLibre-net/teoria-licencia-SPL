...
* **Amerizaje (**: qué hacer si el agua es inevitable.
...
* **Barrido sectorial:** divide el horizonte en sectores de 15-20° (). Mueve los ojos de sector en sector, deteniéndote brevemente en cada uno. La visión periférica detecta el movimiento, pero para resolver si es una aeronave necesitas mirar directamente.
...
::: {.callout-note}
⚓ **AIRMANSHIP / BUENAS PRÁCTICAS: EL COMPORTAMIENTO DE LOS BUITRES**
...
Las **** —los vórtices de punta de ala generados por aeronaves pesadas— son invisibles, persistentes y extraordinariamente peligrosas para un planeador. Se forman en el momento del despegue y durante toda la fase de vuelo, descendiendo lentamente y desplazándose lateralmente con el viento.
...
En final, utiliza la técnica del **«cangrejo»**: apunta el morro hacia el viento para compensar la deriva y mantener la trayectoria sobre tierra alineada con la pista. Justo antes de tocar tierra, usa el pedal para alinear el morro con la pista y el alerón para bajar el ala que recibe el viento, asegurando que la rueda principal toca sin deriva lateral (). Una toma con deriva lateral significativa puede romper el tren de aterrizaje o provocar un derrape que lleve el planeador fuera de la pista.
...
Aunque el planeador opera principalmente sobre tierra, el vuelo de travesía puede llevar al piloto sobre grandes masas de agua —lagos, pantanos, ríos— en caso de agotamiento de sustentación. Si el **** es inevitable:
