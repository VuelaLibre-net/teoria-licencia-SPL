...
Antes de cada vuelo, verifica los cuatro pilares de la aeronave. Tres son documentales y los enumera **SAO.GEN.155**: **aeronavegabilidad** (certificado de aeronavegabilidad + ARC en vigor), **matrícula** (certificado de matrícula) y **manual de vuelo** (AFM a bordo). El cuarto no es un papel, sino una comprobación que te impone **SAO.GEN.130(d)(4)** como piloto al mando: la **pesada y el centrado** dentro de los límites del manual. Si alguno falla, el planeador no vuela.
:::
...
Antes del primer despegue del día, el piloto al mando debe realizar una inspección de 360 grados alrededor de la aeronave siguiendo un orden lógico y utilizando la lista de comprobación oficial de su AFM (@fig-06-cap01-inspeccion-prevuelo):

![Ejemplo de una inspección prevuelo detallada en sentido anti-horario de un ASK-21](imagenes/06-cap01-prevuelo.jpg){#fig-06-cap01-inspeccion-prevuelo}

![Ejemplo de checklist de inspecciones diarias del manual de vuelo de un ASK-21 (Y recuerda: Usa las listas oficiales de tu propio avión)](imagenes/checklist-prevuelo.png){#fig-06-cap01-checklist-prevuelo}
...
::: {.callout-note title="Airmanship: LA REGLA TRADICIONAL CRISE"}
...
* **Los papeles del planeador (SAO.GEN.155) y su estado (SAO.GEN.130)**: antes de cada vuelo verifica los cuatro pilares de la aeronave. Tres los enumera SAO.GEN.155: aeronavegabilidad (certificado + ARC), matrícula y manual de vuelo (AFM). El cuarto te lo exige SAO.GEN.130(d)(4) como piloto al mando: la pesada y el centrado dentro de los límites del manual. Si falta alguno, el planeador no vuela.
