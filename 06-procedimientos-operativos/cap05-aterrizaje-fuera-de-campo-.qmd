...
Para evaluar si un campo es apto en los pocos segundos que tienes disponibles, utiliza la regla de las **7 S**. Este método te obliga a evaluar los factores correctos en el orden correcto, evitando que la urgencia te lleve a pasar por alto un riesgo crítico ():
