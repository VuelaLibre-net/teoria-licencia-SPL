...
Las bandas altas de la tabla concuerdan con la escala clásica de George de probabilidad de tormenta de masa de aire (15–20 ≈ 20 %, 21–30 ≈ 20–60 %, 31–35 ≈ 60–80 %). Las tres primeras filas, en cambio, son una adaptación operativa de esta colección: por debajo de 15 la escala meteorológica no distingue nada, porque sólo pronostica tormentas, y para el volovelista ahí está justo la diferencia entre un día sin térmica y un buen día.
...
Las tablas de umbrales de los apartados anteriores tienen ocho tramos cada una porque describen todo el espectro, de la calma a la tormenta severa. La tabla siguiente resume la banda útil de cada índice; las tablas completas son material de campo para cuando vueles de verdad:
...
: Los cuatro índices de sondeo: bandas de referencia para el vuelo a vela

La regla de oro para la cabina: un índice aislado no decide nada. TT y K dicen si el día vuela; CAPE y LI, cuánta energía tiene y si esa energía puede volverse contra ti en forma de tormenta.
