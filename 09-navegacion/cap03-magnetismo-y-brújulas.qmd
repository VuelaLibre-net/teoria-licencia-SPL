...
* ****: Es el punto por donde pasa el eje de rotación de la Tierra. Es el norte que verás en los mapas y cartas aeronáuticas.
* ****: Es el punto hacia el que apuntan las agujas de nuestras brújulas. Curiosamente, este punto no es fijo y se desplaza ligeramente cada año.

 

La diferencia angular entre ambos se denomina **** o **Declinación**. En las cartas aeronáuticas, verás unas líneas discontinuas llamadas **** que indican el valor de esta variación en cada zona.
...
El planeador no es un entorno magnéticamente puro. Los tubos de acero del fuselaje, los altavoces de la radio y los instrumentos electrónicos generan sus propios campos magnéticos que "engañan" a la brújula. Este error local se llama ****.

 

Para compensarlo, cada aeronave debe tener una **** instalada a la vista del piloto ().
...
Recordamos esto con la regla inglesa ****: **A**ccelerate **N**orth, **D**ecelerate **S**outh. Es decir: al **acelerar**, la brújula tiende al **Norte**; al **decelerar**, tiende al **Sur**.
