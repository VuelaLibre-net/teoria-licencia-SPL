...
* ****: fijamos la posición reconociendo el terreno (ríos, carreteras, pueblos) y comparándolo con la carta.
...
No confíes en una sola referencia. Para confirmar tu posición, usa la técnica de la triangulación
Triangulación (Líneas de posición)
 o líneas de posición:
...
Si en algún momento no estás seguro de tu posición exacta (Uncertainty of Position
UOP (Incertidumbre de posición / Uncertainty of Position)
), mantén la calma y sigue este protocolo:
...
* **Busca "**: Vuela hacia la referencia más grande y lineal que veas (una costa, una cordillera principal).
