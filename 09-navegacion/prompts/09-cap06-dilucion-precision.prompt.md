---
schema: 1
figura: 09-cap06-dilucion-precision.png
...
# 09-cap06-dilucion-precision

**Qué enseña.** Dos bóvedas celestes con cuatro satélites cada una, bien repartidos y agrupados, con la DOP y el error resultante en cifras.

**Por qué existe.** Figura nueva. La DOP se citaba como concepto sin mostrar su efecto.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap06-dilucion-precision
```
