---
schema: 1
figura: 09-cap04-computador-cara-viento.png
...
# 09-cap04-computador-cara-viento

**Qué enseña.** Esquema de la cara del viento de un computador circular: aro de grados, índice superior, arcos de TAS, ojal central, marca del viento y desplazamiento lateral.

**Por qué existe.** Figura nueva, para el apartado del computador de vuelo que pide la GUIA_ESTILO §6.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap04-computador-cara-viento
```
