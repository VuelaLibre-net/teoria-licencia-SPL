---
schema: 1
figura: 09-cap05-triangulacion.png
...
# 09-cap05-triangulacion

**Qué enseña.** Dos líneas de posición cortándose casi perpendicularmente y de forma muy abierta, con la elipse de incertidumbre resultante en cada caso.

**Por qué existe.** Sustituye a la ilustración provisional homónima (tarea 9.3) y añade lo que aquélla no decía: que el ángulo de corte determina la calidad del punto.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap05-triangulacion
```
