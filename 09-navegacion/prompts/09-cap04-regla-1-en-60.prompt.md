---
schema: 1
figura: 09-cap04-regla-1-en-60.png
...
# 09-cap04-regla-1-en-60

**Qué enseña.** El error cometido y el ángulo de cierre como dos ángulos distintos, con las distancias recorrida y restante acotadas por separado.

**Por qué existe.** Figura nueva. La regla popular «dobla el error» sólo vale a mitad de tramo y esa condición no se ve sin dibujarla.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap04-regla-1-en-60
```
