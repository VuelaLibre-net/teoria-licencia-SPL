---
schema: 1
figura: 09-cap02-tres-nortes.png
...
# 09-cap02-tres-nortes

**Qué enseña.** Norte verdadero, magnético y de la brújula, con la variación y el desvío marcados como arcos. Ángulos exagerados, con las cifras reales en el pie.

**Por qué existe.** Figura nueva. Variación y desvío se explicaban por separado y en el cálculo aparecen encadenados.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap02-tres-nortes
```
