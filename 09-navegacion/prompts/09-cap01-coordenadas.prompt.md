---
schema: 1
figura: 09-cap01-coordenadas.png
...
# 09-cap01-coordenadas

**Qué enseña.** La red de paralelos y meridianos sobre un globo, con el ecuador y el meridiano de Greenwich destacados y el orden en que se escriben unas coordenadas.

**Por qué existe.** Sustituye a la ilustración provisional homónima (tarea 9.3 del PLAN-ACCION de la auditoría de julio de 2026), que no llevaba ni un rótulo.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap01-coordenadas
```
