---
schema: 1
figura: 09-cap04-triangulo-velocidades.png
...
# 09-cap04-triangulo-velocidades

**Qué enseña.** El triángulo de velocidades con los tres vectores a la misma escala y acotado en km/h y en nudos: rumbo y TAS, viento, ruta y velocidad suelo, más el arco del WCA.

**Por qué existe.** Sustituye a la ilustración provisional 09-cap04-triangulo-viento.jpg (tarea 9.3). El informe de auditoría pedía expresamente las cotas en km/h y nudos.
...
```bash
python3 tools/figuras/09_navegacion.py 09-cap04-triangulo-velocidades
```
