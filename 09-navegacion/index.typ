...
/ \*\*\*\*AGL (Altura sobre el terreno / Above Ground Level)\*\*\*\*: #block[
...
/ \*\*\*\*AMA (Altitud Mínima de Área)\*\*\*\*: #block[
...
/ \*\*\*\*AMSL (Altitud sobre el nivel del mar / Above Mean Sea Level)\*\*\*\*: #block[
...
/ \*\*\*\*ANDS (Error de aceleración de la brújula)\*\*\*\*: #block[
...
/ \*\*\*\*Datum WGS-84 (World Geodetic System 1984)\*\*\*\*: #block[
...
/ \*\*\*\*DOP (Dilución de la precisión)\*\*\*\*: #block[
...
/ \*\*\*\*Error de viraje (regla "NO me paso / SÍ me paso")\*\*\*\*: #block[
...
/ \*\*\*\*Espacio aéreo controlado\*\*\*\*: #block[
...
/ \*\*\*\*GNSS (Sistema Global de Navegación por Satélite)\*\*\*\*: #block[
...
/ \*\*\*\*GPS (Global Positioning System)\*\*\*\*: #block[
...
/ \*\*\*\*GS (Velocidad suelo / Ground Speed)\*\*\*\*: #block[
...
/ \*\*\*\*IGC (Registrador de vuelo / Logger)\*\*\*\*: #block[
...
/ \*\*\*\*Loxodrómica (Línea de rumbo)\*\*\*\*: #block[
...
/ \*\*\*\*Navegación a estima (Dead Reckoning)\*\*\*\*: #block[
...
/ \*\*\*\*Norte verdadero (Geográfico)\*\*\*\*: #block[
...
/ \*\*\*\*Ortodrómica (Círculo máximo)\*\*\*\*: #block[
...
/ \*\*\*\*Proyección Lambert (cónica conforme)\*\*\*\*: #block[
...
/ \*\*\*\*SERA (Standardised European Rules of the Air / Reglas Europeas Estandarizadas del Aire)\*\*\*\*: #block[
...
/ \*\*\*\*TAS (Velocidad verdadera / True Air Speed)\*\*\*\*: #block[
...
/ \*\*\*\*Triangulación (Líneas de posición)\*\*\*\*: #block[
...
/ \*\*\*\*Triángulo de velocidades (Triángulo del viento)\*\*\*\*: #block[
...
/ \*\*\*\*UOP (Incertidumbre de posición / Uncertainty of Position)\*\*\*\*: #block[
...
/ \*\*\*\*UTC (Tiempo Universal Coordinado / Hora Zulu)\*\*\*\*: #block[
...
/ \*\*\*\*Variación magnética (Declinación)\*\*\*\*: #block[
...
/ \*\*\*\*WCA (Ángulo de corrección de deriva / Wind Correction Angle)\*\*\*\*: #block[
