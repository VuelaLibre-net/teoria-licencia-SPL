# Libro 6 — Procedimientos Operativos · Texto de media-kit

---

## Blurb corto (redes sociales / catálogo)

> Saber volar no es suficiente. Los pilotos que vuelven saben operar: antes del vuelo, durante y cuando nada sale como estaba previsto.

El **Libro 6 de Procedimientos Operativos** del Manual SPL cubre cada procedimiento del vuelo sin motor desde el primer chequeo prevuelo hasta el paracaídas de emergencia que nunca quieres usar pero que debes saber desplegar.
...
Un piloto puede tener una técnica impecable en los mandos y, aun así, enfrentarse a situaciones para las que no tiene un protocolo. Un lanzamiento a torno que no progresa como esperaba. Un campo fuera que no habías visto desde el suelo. Una emergencia a trescientos metros de altura en la que cada segundo con el plan equivocado acorta las opciones.

Los procedimientos existen para que en esos momentos el cerebro no tenga que improvisar. Para que la secuencia correcta ya esté grabada antes de que la adrenalina tome el mando.

El **Libro 6: Procedimientos Operativos** cubre todos los escenarios operativos del vuelo a vela: los rutinarios que se repiten cien veces hasta volverse automáticos, y los críticos que ocurren una sola vez y no admiten error.

Con el rigor de un manual de vuelo y el tono del instructor que ha vivido de primera mano lo que pasa cuando el procedimiento no se sigue, este volumen cubre los ocho bloques temáticos del syllabus EASA AMC1 SFCL.130:
...
Para el **alumno que prepara el examen teórico AESA SPL** y quiere entender la lógica operativa detrás de cada procedimiento, no memorizarlos como pasos desconectados.

Para el **piloto en transición** que pasa de vuelo local a vuelos de distancia y necesita consolidar los procedimientos de campo fuera y planificación de alternativas.

Para **cualquier instructor de vuelo** que necesita un referente actualizado del syllabus operativo para estructurar sus briefings de tierra.
