...
* **QNH** = ** (Altitud sobre el nivel del mar).
* **QFE** = ** (Altura sobre el campo de vuelo).
...
2. Si el piloto no puede determinar ese efecto, según EASA
  EASA (Agencia de la Unión Europea para la Seguridad Aérea / European Union Aviation Safety Agency)
   el oxígeno **deberá** usarse siempre por encima de los **10.000 ft**.
