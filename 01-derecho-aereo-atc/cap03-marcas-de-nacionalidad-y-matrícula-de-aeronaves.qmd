...
En España, la marca de nacionalidad es `EC`, seguida de un guion y tres letras: por ejemplo, `EC-ABC`. Estas marcas las asigna el Estado (AESA) y son únicas para cada aeronave.
...
* **Nacionalidad y matrícula**: en España, **EC-** seguida de tres letras (ej: EC-ABC).
