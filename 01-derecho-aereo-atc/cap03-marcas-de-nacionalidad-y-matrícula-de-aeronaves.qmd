...
En España, la marca de nacionalidad es `EC`, seguida de un guion y tres letras: por ejemplo, `EC-BOH`. Estas marcas las asigna el Estado (AESA
AESA (Agencia Estatal de Seguridad Aérea)
) y son únicas para cada aeronave.
...
Según la normativa española (y el Anexo 7 de OACI
OACI (Organización de Aviación Civil Internacional / ICAO)
), en los aerodinos (aviones y planeadores):
...
Si el planeador es muy estilizado y no caben marcas de este tamaño, la autoridad puede aceptar dimensiones reducidas, siempre que sigan siendo legibles ().
...
En ella van grabados la marca de nacionalidad, la matrícula y los datos de fabricante, modelo y número de serie (). Su razón de ser es sombría pero importante: si hay un accidente con fuego, la placa debe sobrevivir para que la aeronave pueda identificarse.
...
**EC** = Nemotecnia **. La marca oficial OACI para España es "EC".
