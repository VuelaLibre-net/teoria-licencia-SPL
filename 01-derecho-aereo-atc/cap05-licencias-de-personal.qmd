...
* Qué es la licencia SPL
  SPL (Licencia de Piloto de Planeador / Sailplane Pilot Licence)
  : validez, privilegios y normativa aplicable (Part-SFCL).
* Las diferencias entre el certificado médico LAPL
  LAPL (Light Aircraft Pilot License)
   y el Clase 2, y cuánto duran.
...
Puedes obtenerla a los 16 años, aunque ya a los 14 puedes volar solo como alumno. Te da derecho a actuar como piloto al mando (PIC
PIC (Piloto al mando / Pilot in Command)
) en planeadores y motoveleros, y en teoría es **vitalicia**: el papel no caduca.
...
Vale tanto un certificado **Clase 2** como un **LAPL** (**Light Aircraft Pilot Licence**). Para la mayoría de pilotos deportivos, el LAPL es suficiente y menos exigente. Su validez depende de tu edad: **60 meses** (5 años) si tienes menos de 40, y **24 meses** (2 años) a partir de los 40 (). Ojo con el matiz de MED.A.045: un certificado emitido **antes** de cumplir los 40 deja de ser válido cuando cumples los **42**, aunque los 60 meses no hayan vencido. Si te lo expidieron a los 39, no te vale hasta los 44: caduca a los 42.
...
Para volar solo o con pasajeros debes demostrar que estás al día. La normativa SFCL establece una ventana móvil de los **últimos 24 meses**, dentro de los cuales, para mantener activos tus privilegios en planeadores (excluyendo TMG
...
No pierdes la licencia; tus privilegios quedan "dormidos". Para despertarlos tienes dos caminos: pasar una **verificación de competencia** (**proficiency check**) con un examinador, o volar con instructor en doble mando hasta completar lo que te falte ().
