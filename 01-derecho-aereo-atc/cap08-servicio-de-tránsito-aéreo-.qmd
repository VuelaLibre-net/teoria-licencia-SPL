...
* Los tres servicios ATS: Control (ATC
...
Se organiza en tres dependencias según la fase de vuelo ():

1. **Torre** (TWR
  TWR (Torre de Control / Aerodrome Control Tower)
  ): controla el aeródromo y el circuito (despegues, aterrizajes, rodaje).
2. **Aproximación** (APP
  APP (Control de Aproximación / Approach Control)
  ): controla la entrada y salida de la zona del aeropuerto.
3. **Centro de Control de Área** (ACC
  ACC (Centro de Control de Área / Area Control Centre)
  ): controla los aviones en ruta, arriba del todo.
...
Tu seguro de vida. Se activa cuando hay una emergencia o se teme por la seguridad de una aeronave, y funciona en tres fases de preocupación creciente ():
