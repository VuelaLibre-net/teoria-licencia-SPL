...
El SAR no sale a buscar "porque sí". Actúa escalonadamente según la gravedad, en fases que activa el ATC
...
3. **DETRESFA (Socorro)**: peligro grave. Una señal de baliza ELT, un accidente avistado. Despegan los medios: aviones y helicópteros ().
...
Si estás en tierra y te busca un avión, tienes que comunicarte. Sin radio, usa el **Código de Señales Visuales**: hazlas grandes (mínimo 2,5 m) y con contraste, usando telas, piedras o surcos ().
