...
![La curva polar y sus tres velocidades clave:  entrada en pérdida; máximo tiempo de vuelo; máximo planeo.](imagenes/07-cap02-polar-anotada.png){#fig-07-cap02-polar-anotada}
...
La @fig-07-cap02-ias-tas-altitud pone cifras a esa separación: despegando de un aeródromo de la meseta ya vuelas un 7 % más deprisa de lo que marca el instrumento, y en el techo de una onda, un 27 %.

![Lo que separa la TAS de la IAS al subir, con la regla del 2 % por cada 300 m: para una indicada de 100 km/h, la velocidad real crece un 7 % sobre la meseta y un 27 % en el techo de onda](imagenes/07-cap02-ias-tas-altitud.png){#fig-07-cap02-ias-tas-altitud width="100%"}
