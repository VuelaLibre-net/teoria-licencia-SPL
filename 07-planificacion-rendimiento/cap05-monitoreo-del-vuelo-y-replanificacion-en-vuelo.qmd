...
Calcular el planeo final una sola vez y volarlo a fe ciega es apostar la tarea —y el planeador— a que la masa de aire no cambie. El método profesional verifica el margen en tres puntos:
...
La fuerza del método está en la tendencia: una lectura te dice dónde estás; dos lecturas comparadas te dicen hacia dónde vas. Una descendencia continua de 0,5 m/s se pierde entre el ruido del variómetro, pero salta a la vista al comparar el margen del punto inicial con el del punto medio (@fig-07-cap05-metodo-tres-puntos).

![Las dos trazas del planeo final: el margen que aguanta en +300 m y el que cae a +150 m en el punto medio y sigue bajando. Lo que decide no es el valor, es la pendiente](imagenes/07-cap05-metodo-tres-puntos.png){#fig-07-cap05-metodo-tres-puntos width="100%"}
