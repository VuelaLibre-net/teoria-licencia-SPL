...
## [1.0-rc.2] — 4 de agosto de 2026

> Responde a la carencia que la `1.0-rc.1` dejaba anotada: era, con el libro 9, el más flojo de la
> colección en apoyo visual. El 9 ya se amplió; aquí se cierra la parte de las figuras **sin tocar el
> texto**, que un instructor ya validó como contenido suficiente.

**Qué releer:** **nada del texto.** Ni una línea del contenido validado cambia. Lo que entra son tres figuras nuevas y, en el cap03, las referencias normativas de cada tipo de tarea. Si revisas algo, revisa que las cifras de las tres figuras coinciden con las del texto: salen de ahí, y no hay ningún guardián que detecte una divergencia.
