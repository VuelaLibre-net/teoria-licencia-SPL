...
* **Vuelo VFR nocturno**: si el vuelo va a salir de las inmediaciones del aeródromo (caso excepcional en planeador).
...
* **Casilla 15 (velocidad y ruta)**: la casilla pide la **velocidad verdadera (TAS)** de crucero, con **K** para km/h (ej. K0120) o **N** para nudos (ej. N0065); en un planeador se anota la media de crucero estimada de la tarea, que es la única cifra que puedes dar de antemano. Como ruta, los puntos de viraje o áreas (ej. DCT VTC-1 DCT VTC-2 DCT).
...
* **Casilla 19 (información suplementaria)**: no se transmite con el mensaje FPL, pero es la información que usará el SAR si no apareces: autonomía (`E/`, que el formulario define como autonomía **de combustible** en horas y minutos; el planeador puro no lo lleva, así que por convenio se anotan las horas de luz que restan hasta la puesta de sol), personas a bordo (`P/`), equipo de radio de emergencia (`R/`), equipo de supervivencia (`S/`) y si llevas **ELT** o baliza personal (PLB). Rellénala con el mismo cuidado que el resto: puede acortar tu rescate en horas.
...
* **Casillas clave**: velocidad (casilla 15): la **TAS** de crucero, con **K** para km/h (K0120) o **N** para nudos (N0065); en planeador se anota tu media estimada. Destino fuera de aeródromo: ZZZZ en la casilla 16 y el detalle con coordenadas en la 18. Casilla 19: autonomía (**E/** es autonomía de combustible; el planeador puro no lo lleva y por convenio se anotan las horas hasta la puesta de sol), personas a bordo, ELT/PLB y equipo de supervivencia; es lo que usará el SAR.
...
* **Motoveleros (TMG)**: si vuelas un TMG como avión de turismo, sigues las mismas reglas que un avión ligero de aviación general: declara autonomía de combustible real, no solar.
