...
Rellenar un formulario ICAO para un avión sin motor tiene sus peculiaridades ():
...
¿Y si despegas de un campo sin cobertura ni acceso a la aplicación ICARO de ENAIRE? El reglamento prevé la presentación del plan de vuelo **en vuelo (AFIL, **, transmitiéndolo por radio a una dependencia ATS:
