...
> As the glider climbs, atmospheric pressure falls and less oxygen is available to the body. This chapter explains the mechanisms behind hypoxia and hyperventilation, describes their symptoms and treatment, and sets out the regulatory requirements and the oxygen equipment you need to know to fly safely at altitude.

## The atmosphere and the gas laws

To understand how altitude affects you in a glider cockpit, which is not pressurised, you need two basic principles of physics.

The atmosphere is made up of 78% nitrogen and 21% oxygen. Those percentages stay the same as you climb; what changes significantly is the **atmospheric pressure**.

**Dalton's law** states that the total pressure of a mixture of gases is the sum of the partial pressures of its components. As you climb, there is less air above you, so the overall pressure falls. At sea level, that pressure “pushes” oxygen molecules efficiently through the alveoli of the lungs into the blood. At high altitude, the pressure is so low that oxygen does not have enough force to cross the alveolar membrane: the pilot is breathing 21% oxygen but suffering oxygen starvation at cell level.
...
Flying at high altitude is the most common cause, but hypoxia can arise from four different mechanisms:

1. **Hypoxic hypoxia:** The atmospheric pressure is too low to transfer oxygen into the blood. This is the most frequent form in glider pilots. You correct it by starting a descent or turning on the supplemental oxygen.
...
The symptoms of hypoxia vary from person to person and depend on factors such as fatigue, smoking, alcohol or acclimatisation to altitude. Pilots often do not notice their own symptoms.
...
The TUC is the time between the oxygen supply being cut off and the pilot losing the ability to take protective action. The higher the altitude, the less time there is to react.
...
A descent from 7,000 m to 3,000 m at a rate of 5 m/s takes more than 13 minutes, often longer than the TUC available at that altitude. Starting the descent without oxygen may be too late.

::: {.callout-tip title="Golden rule"}
At any failure of the oxygen supply, or any suspicion of hypoxia, apply the rule: **“100% oxygen and descend”**. Turn the flow fully on and get below 10,000 ft without hesitation. Above a certain altitude, the TUC does not leave you able to think or act properly.
:::

### Prevention and treatment

The best prevention is to anticipate risky situations and use the oxygen equipment as a matter of routine, almost automatically.
...
Hyperventilation is abnormally fast or deep breathing caused not by a lack of oxygen but by stress or anxiety. In a glider it can be triggered by severe turbulence, a difficult field landing or hard decisions in flight.

When you hyperventilate, you breathe out too much CO~2~. The body regulates blood flow to the brain according to the level of CO~2~ dissolved in the blood: when that level falls (hypocapnia), the blood vessels in the brain constrict and less oxygen reaches it, even though the lungs are full of it. The paradoxical result is that the pilot is suffocating with full lungs.

### Symptoms

The symptoms of hyperventilation are similar to those of hypoxia, which makes it hard to tell them apart:
...
The aim is to bring the CO~2~ in your blood back to normal. To do that:

1. **Slow your breathing down:** Breathe in slowly and deeply, and hold the air for a few seconds before breathing out.
2. **Talk out loud:** Read the *checklist* or count out loud. Talking forces you to control your breathing out and makes panting difficult.
...
::: {.callout-warning title="Safety"}
Do not use supplemental oxygen if you diagnose hyperventilation and you are not at high altitude: more oxygen would worsen the CO~2~ imbalance and make the symptoms worse. If you cannot confirm that you are below 10,000 ft, treat for hypoxia first.
:::
...
So the 10,000 ft threshold is not an unconditional legal limit. It is the default rule when you cannot judge how a lack of oxygen will affect the people on board. The underlying obligation is the first one: assess, and make sure.

::: {.callout-note title="Airmanship"}
For flights **at night or at dusk** it is recommended (not required by the rules) to start using oxygen from **5,000 ft**: night vision is especially sensitive to a lack of oxygen, because the rods in the peripheral retina are the first cells to be affected.
:::
...
::: {.callout-warning title="Safety"}
**Aviation oxygen, not medical oxygen.** Medical oxygen contains more moisture, which can freeze in the regulator at the temperatures found at high altitude and block the flow. Use only oxygen labelled “for aviation use” (dry oxygen, more than 98.5% pure).

**No grease anywhere near it.** Do not put moisturising cream, sunscreen or lubricants near the connections, regulators or nozzles. Oxygen under pressure in contact with greasy substances can ignite explosively without any flame or spark.
:::

## Pulse oximeter

The pulse oximeter is a non-invasive device that measures the oxygen saturation of the blood (SpO~2~) and the heart rate in real time (@fig-02-cap04-pulsioximetro). It is the most useful instrument for detecting hypoxia before the symptoms become obvious to the pilot.
...
An SpO~2~ below **90%** means clear hypoxia and calls for immediate action: turn on the supplemental oxygen and start descending.

::: {.callout-note title="Airmanship"}
Record your SpO~2~ at different altitudes on your usual flights (at 3,000 m, at 5,000 m) so that you know how you personally respond and have your own reference values. Not every pilot responds to altitude in the same way.
:::
