...
Whether thermalling or on final approach, the pilot is constantly assessing situations and hazards, making plans, managing the level of risk and acting on it. One of the most widely accepted frameworks in civil aviation for training and shaping ADM is the **DECIDE model** (@fig-02-cap03-decide):
...
The mind can only handle so much of this endless stream of events at once: think of it as a glass that holds a fixed amount of water. During a turbulent aerotow, flying into the sun, while trying to spot another glider that has just called on base, the cognitive glass can overflow spectacularly. This is known as **qualitative overload**. When the complexity of the flying task at that precise moment outstrips the pilot's performance and training, the safety margin disappears and the latent accident takes its place.
