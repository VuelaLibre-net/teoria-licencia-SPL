...
> Mass and balance are the foundations of safety on every flight. The numbers you write down in the hangar have very real physical consequences: they decide whether the glider handles like a glove or turns unpredictable.
>
>
...
The centre of gravity is the point through which the glider's whole weight acts. Longitudinal stability depends on its position relative to the centre of pressure: where the CG lies decides how the aircraft responds to the stick.
...
The lesson is in which way the CG moves: **the lighter the pilot, the further aft the CG moves**, because the seat is forward of the *datum* and its moment is the one pulling the whole towards the front.
...
One thing you cannot get wrong: dump the water before landing. The extra weight on touchdown can seriously damage the undercarriage and the fuselage. Dumping takes between 3 and 8 minutes depending on the glider, so plan it before you join the circuit.

### Fin ballast: the clever counterweight

Many modern gliders carry a small water tank in the fin: the fin ballast (*tail tank*). It is there to move the CG, not to add weight. The main wing tanks usually sit slightly forward of the centre of gravity, so filling them moves the CG forward and brings in trim drag. A few litres in the tail return the CG to its optimum position, close to the aft limit, where drag is lowest.
