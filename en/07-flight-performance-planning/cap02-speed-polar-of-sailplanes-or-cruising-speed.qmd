...
Remember the water ballast from the previous chapter? This is why it works, shown on the graph. As the weight (wing loading) increases, the whole polar curve shifts to the right and downwards, sliding along the tangent from the origin (@fig-07-cap02-polar-peso). There are three consequences:
