...
* **Overtaking**: if you catch up with another aircraft from behind, the one ahead has priority. Overtake it on its **right**. With one exception made to measure for us: a glider overtaking another glider may do so **on the right or on the left** (useful on a ridge, where only one side is safe).
