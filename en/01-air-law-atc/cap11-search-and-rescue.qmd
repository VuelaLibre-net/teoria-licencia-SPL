...
> When everything else fails, the Search and Rescue system is your last line of defence; it lets them find you.
>
>
...
The Search and Rescue service (**SAR**) is your final safety net. In Spain it is the responsibility of the **Ejército del Aire** (the Spanish Air and Space Force), supported by other assets, and its mission is simple: to find you and save you.

### Organisation

The one pulling the strings is the **RCC** (Rescue Coordination Centre). There are three main ones in Spain:
...
SAR does not go out searching “just because”. It acts in stages according to severity, in phases activated by ATC or by the RCC itself:
...
If you are on the ground and an aircraft is looking for you, you have to communicate. Without a radio, use the **visual signals code**: make them large (at least 2.5 m) and with contrast, using cloth, stones or furrows (@fig-01-cap11-senales-tierra-aire).
...
If in flight you pick up a distress signal (visual or on 121.5 MHz):
...
If something goes wrong, SAR will look for you. Know the phases:
